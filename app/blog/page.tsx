        ...
        <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-3">
          {featuredPosts.map((post: Post) => (
            ...
            >
              {post.mainImage && (
                <Image
                  alt={typeof post.mainImage === 'object' && 'alt' in post.mainImage ? post.mainImage.alt : ''}
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    {post.author.image && (
                      <Image
                        ...
                        src={post.author.image ? image(post.author.image).size(64, 64).url() : ''}
                        width={24}
                        height={24}
    ...
    <div className="flex flex-wrap items-center justify-between gap-2">
      <Menu>
        <MenuButton className="flex items-center justify-between gap-2 font-medium">
          {categories.find((category: Category) => category.slug === selected)?.title ||
            'All categories'}
